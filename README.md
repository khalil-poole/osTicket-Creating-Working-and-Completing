...
*Creator note* - don't pay attention to the discrepancy of the dates within the screenshots as there have been some minor changes that I had to do when I realized that I was logged in as the admin the whole time instead of an agent.
